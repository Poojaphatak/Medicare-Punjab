...
export declare type HMSPollUserTrackingMode = 'peerID' | 'customerID' | 'userName';
export declare type HMSPollState = 'created' | 'started' | 'stopped';
...
export interface HMSPollCreateParams extends Pick<HMSPoll, 'id' | 'title' | 'type' | 'duration' | 'anonymous' | 'visibility' | 'locked' | 'mode' | 'rolesThatCanVote' | 'rolesThatCanViewResponses'> {
...
export declare enum HMSPollStates {
    CREATED = "created",
    STARTED = "started",
    STOPPED = "stopped"
}
...
export declare type HMSPollQuestionResponseCreateParams = Omit<HMSPollQuestionResponse, 'type' | 'peer' | 'update' | 'responseFinal'>;
