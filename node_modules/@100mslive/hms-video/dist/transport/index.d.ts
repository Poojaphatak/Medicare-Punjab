...
import { HLSConfig, HLSTimedMetadata, HMSPermissionType, HMSRole, HMSRoleChangeRequest, HMSWhiteboardCreateOptions } from '../interfaces';
...
export default class HMSTransport implements ITransport {
    ...
    fetchLeaderboard(params: PollLeaderboardGetParams): Promise<PollLeaderboardGetResponse>;
    ...
    }): Promise<import("../signal/interfaces").GetWhiteboardResponse>;
