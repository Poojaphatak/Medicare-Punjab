"use strict";var Jr=Object.create;var Ge=Object.defineProperty,zr=Object.defineProperties,Yr=Object.getOwnPropertyDescriptor,Xr=Object.getOwnPropertyDescriptors,Zr=Object.getOwnPropertyNames,mt=Object.getOwnPropertySymbols,Zi=Object.getPrototypeOf,gi=Object.prototype.hasOwnProperty,er=Object.prototype.propertyIsEnumerable,es=Reflect.get;var Xi=(n,e,t)=>e in n?Ge(n,e,{enumerable:!0,configurable:!0,writable:!0,value:t}):n[e]=t,m=(n,e)=>{for(var t in e||(e={}))gi.call(e,t)&&Xi(n,t,e[t]);if(mt)for(var t of mt(e))er.call(e,t)&&Xi(n,t,e[t]);return n},y=(n,e)=>zr(n,Xr(e));var Si=(n,e)=>{var t={};for(var i in n)gi.call(n,i)&&e.indexOf(i)<0&&(t[i]=n[i]);if(n!=null&&mt)for(var i of mt(n))e.indexOf(i)<0&&er.call(n,i)&&(t[i]=n[i]);return t};var ts=(n,e)=>()=>(e||n((e={exports:{}}).exports,e),e.exports),is=(n,e)=>{for(var t in e)Ge(n,t,{get:e[t],enumerable:!0})},tr=(n,e,t,i)=>{if(e&&typeof e=="object"||typeof e=="function")for(let r of Zr(e))!gi.call(n,r)&&r!==t&&Ge(n,r,{get:()=>e[r],enumerable:!(i=Yr(e,r))||i.enumerable});return n};var gt=(n,e,t)=>(t=n!=null?Jr(Zi(n)):{},tr(e||!n||!n.__esModule?Ge(t,"default",{value:n,enumerable:!0}):t,n)),rs=n=>tr(Ge({},"__esModule",{value:!0}),n);var H=(n,e,t)=>es(Zi(n),t,e);var d=(n,e,t)=>new Promise((i,r)=>{var s=l=>{try{o(t.next(l))}catch(p){r(p)}},a=l=>{try{o(t.throw(l))}catch(p){r(p)}},o=l=>l.done?i(l.value):Promise.resolve(l.value).then(s,a);o((t=t.apply(n,e)).next())});var ki=ts((Ka,us)=>{us.exports={name:"@100mslive/hms-video",version:"0.9.28",license:"MIT",main:"dist/index.cjs.js",typings:"dist/index.d.ts",module:"dist/index.js",files:["dist","src"],engines:{node:">=10"},exports:{".":{require:"./dist/index.cjs.js",import:"./dist/index.js",default:"./dist/index.js"}},scripts:{prestart:"rm -rf dist && yarn types:build",start:'concurrently "yarn dev" "yarn types"',dev:"node ../../scripts/dev","build:only":"node ../../scripts/build",build:"yarn build:only && yarn types:build",types:"tsc -w","types:build":"tsc -p tsconfig.json",test:"jest --maxWorkers=1",lint:"eslint -c ../../.eslintrc .","lint:fix":"yarn lint --fix",prepare:"yarn build",size:"size-limit",analyze:"size-limit --why",format:"prettier --write src/**/*.ts"},author:"100ms <tech-common@100ms.live>",devDependencies:{"@types/dom-screen-wake-lock":"^1.0.1","@types/sdp-transform":"^2.4.4","@types/ua-parser-js":"^0.7.36","@types/uuid":"^8.3.0","jest-canvas-mock":"^2.3.1","jsdom-worker":"^0.3.0",tslib:"^2.2.0"},dependencies:{eventemitter2:"^6.4.7","sdp-transform":"^2.14.1","ua-parser-js":"^1.0.1",uuid:"^8.3.2","webrtc-adapter":"^8.0.0"},gitHead:"2616c7f5408ccbe73ba402514ca7b87b310d377c"}});var Ws={};is(Ws,{DeviceType:()=>Er,ENV:()=>$e,HMSAudioCodec:()=>_i,HMSAudioContextHandler:()=>X,HMSAudioPluginType:()=>Ri,HMSAudioPluginsManager:()=>be,HMSAudioTrack:()=>ge,HMSException:()=>S,HMSFacingMode:()=>Hi,HMSLocalAudioTrack:()=>ue,HMSLocalStream:()=>ie,HMSLocalVideoTrack:()=>N,HMSLogLevel:()=>dr,HMSMediaStream:()=>oe,HMSPeerListIterator:()=>We,HMSPeerUpdate:()=>Ie,HMSPlaylistType:()=>bt,HMSPluginUnsupportedTypes:()=>je,HMSPollQuestionType:()=>Di,HMSPollStates:()=>Oi,HMSPollsUpdate:()=>kt,HMSRecordingState:()=>vr,HMSRemoteAudioTrack:()=>ee,HMSRemoteStream:()=>$,HMSRemoteVideoTrack:()=>w,HMSRoomUpdate:()=>Li,HMSSdk:()=>zi,HMSSimulcastLayer:()=>Se,HMSStreamingState:()=>fr,HMSTrack:()=>z,HMSTrackType:()=>de,HMSTrackUpdate:()=>Z,HMSVideoCodec:()=>wi,HMSVideoPluginCanvasContextType:()=>Rt,HMSVideoPluginType:()=>It,HMSVideoPluginsManager:()=>Le,HMSVideoTrack:()=>fe,HMSWebrtcInternals:()=>_e,HMSWebrtcStats:()=>we,getLocalDevices:()=>fs,getLocalScreen:()=>vs,getLocalStream:()=>Ci,isBrowser:()=>C,isIOS:()=>Tt,isMobile:()=>Ke,isNode:()=>ne,isPageHidden:()=>fi,isSupported:()=>as,parsedUserAgent:()=>ae,simulcastMapping:()=>At,validateDeviceAV:()=>Is});module.exports=rs(Ws);var he=class{constructor({sender:e,message:t,type:i="chat",recipientPeer:r,recipientRoles:s,time:a,id:o}){this.sender=e,this.message=t,this.type=i,this.recipientPeer=r,this.recipientRoles=s,this.time=a,this.id=o}toSignalParams(){var r,s;let e=(r=this.recipientRoles)==null?void 0:r.map(a=>a.name),t=(s=this.recipientPeer)==null?void 0:s.peerId,i={info:{message:this.message,type:this.type}};return e!=null&&e.length&&(i.roles=e),t&&(i.peer_id=t),i}toString(){var e;return`{
      sender: ${this.sender};
      ...
      type: ${this.type};
      id: ${this.id}
    }`}};var Ue=class{constructor(e){this.recording={server:{running:!1},browser:{running:!1},hls:{running:!1}};this.rtmp={running:!1};this.hls={running:!1,variants:[]};this.id=e}};var ye="renegotiation-callback-id",St="ion-sfu";var Me="SUBSCRIBE_ICE_CONNECTION_CALLBACK_ID";var ir="https://event.100ms.live/v2/client/report",rr="https://event-nonprod.100ms.live/v2/client/report";var L={DEVICE_CHANGE:"device-change",LOCAL_AUDIO_ENABLED:"local-audio-enabled",LOCAL_VIDEO_ENABLED:"local-video-enabled",STATS_UPDATE:"stats-update",RTC_STATS_UPDATE:"rtc-stats-update",TRACK_DEGRADED:"track-degraded",TRACK_RESTORED:"track-restored",TRACK_AUDIO_LEVEL_UPDATE:"track-audio-level-update",LOCAL_AUDIO_SILENCE:"local-audio-silence",ANALYTICS:"analytics",AUDIO_PLUGIN_FAILED:"audio-plugin-failed",POLICY_CHANGE:"policy-change",LOCAL_ROLE_UPDATE:"local-role-update",AUDIO_TRACK_UPDATE:"audio-track-update",AUDIO_TRACK_ADDED:"audio-track-added",AUDIO_TRACK_REMOVED:"audio-track-removed",AUTOPLAY_ERROR:"autoplay-error",LEAVE:"leave"},sr="2.5",ar="20231201",J="_handraise",Ti=1e3,vi=64;var me=class{constructor({peerId:e,name:t,isLocal:i,customerUserId:r,metadata:s,role:a,joinedAt:o,groups:l,realtime:p}){this.customerUserId="";this.metadata="";this.auxiliaryTracks=[];this.name=t,this.peerId=e,this.isLocal=i,this.customerUserId=r,this.metadata=s,this.joinedAt=o,this.groups=l,this.realtime=p,a&&(this.role=a)}get isHandRaised(){var e;return!!((e=this.groups)!=null&&e.includes(J))}updateRole(e){this.role=e}updateName(e){this.name=e}updateNetworkQuality(e){this.networkQuality=e}updateMetadata(e){this.metadata=e}updateGroups(e){this.groups=e}toString(){var e,t,i,r;return`{
      name: ${this.name};
    ...
    }`}};var nr=require("uuid"),ke=class{};ke.makePeerId=()=>(0,nr.v4)();var Be=class extends me{constructor(t){super(y(m({},t),{peerId:ke.makePeerId(),isLocal:!0}));this.isLocal=!0;this.auxiliaryTracks=[];this.asRole=t.asRole}isInPreview(){return!!this.asRole}toString(){var t,i,r;return`{
      name: ${this.name};
  ...
  self.onmessage = function (event) {
    ...
    switch (data) {
      ...
      error=${r.message}`),r}})}shouldSendVideoLayer(t,i){let r=this.getLayer();return this.degraded&&t==="none"?!0:r===t?(c.d(`[Remote Track] ${this.logIdentifier}`,`Not sending update, already on layer ${t}, source=${i}`),!1):!0}},Fi=class{constructor(){this.history=[]}push(e){e.time=new Date().toISOString().split("T")[1],this.history.push(e)}};var ie=class extends oe{constructor(){super(...arguments);this.TAG="[HMSLocalStream]";this.connection=null}setConnection(t){this.connection=t}addTransceiver(t,i){let r=this.connection.addTransceiver(t.getTrackBeingSent(),{streams:[this.nativeStream],direction:"sendonly",sendEncodings:this.getTrackEncodings(t,i)});return this.setPreferredCodec(r,t.nativeTrack.kind),t.transceiver=r,r}setMaxBitrateAndFramerate(t){return d(this,null,function*(){var i;yield(i=this.connection)==null?void 0:i.setMaxBitrateAndFramerate(t)})}setPreferredCodec(t,i){}replaceStreamTrack(t,i){this.nativeStream.addTrack(i),this.nativeStream.removeTrack(t),c.d(this.TAG,"Native stream tracks after replace",this.nativeStream.getAudioTracks().map(ce),`prev Track - ${ce(t)}`,`new Track - ${ce(i)}`)}replaceSenderTrack(t,i){return d(this,null,function*(){if(!this.connection||this.connection.connectionState==="closed"){c.d(this.TAG,"publish connection is not initialised or closed");return}let r=this.connection.getSenders().find(s=>s.track&&s.track.id===t.id);if(r===void 0){c.w(this.TAG,`No sender found for trackId=${t.id}`);return}yield r.replaceTrack(i)})}removeSender(t){var s,a;if(!this.connection||this.connection.connectionState==="closed"){c.d(this.TAG,"publish connection is not initialised or closed");return}let i=(s=t.transceiver)==null?void 0:s.sender;if(!i){c.w(this.TAG,`No sender found for trackId=${t.trackId}`);return}(a=this.connection)==null||a.removeTrack(i);let r=this.tracks.indexOf(t);r!==-1?this.tracks.splice(r,1):c.w(this.TAG,`Cannot find ${t.trackId} in locally stored tracks`)}getTrackEncodings(t,i){let r=[];if(t instanceof N)if(i.length>0)c.d(this.TAG,"Simulcast enabled with layers",i),r.push(...i);else{let s={active:this.nativeStream.active};t.settings.maxBitrate&&!ne&&(s.maxBitrate=t.settings.maxBitrate),r.push(s)}return r}};var $=class extends oe{constructor(t,i){super(t);this.audio=!0;this.video="none";this.connection=i}setAudio(t,i,r){return d(this,null,function*(){this.audio!==t&&(this.audio=t,c.d(`[Remote stream] ${r||""} 
    streamId=${this.id}
    trackId=${i}
